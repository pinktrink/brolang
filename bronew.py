...
class BroLang():
    ...
    coords = Group(
        unit.setResultsName('x') + comma.suppress() + unit.setResultsName('y')
    )
    from_coords = (
        unit.setResultsName('fromx') +
        comma.suppress() +
        unit.setResultsName('fromy')
    )
    to_coords = (
        unit.setResultsName('tox') +
        comma.suppress() +
        unit.setResultsName('toy')
    )

    screen_kw = CaselessKeyword('screen').setResultsName('screen')
    goto_kw = CaselessKeyword('goto').setResultsName('goto')
    clear_kw = CaselessKeyword('clear').setResultsName('clear')
    wait_kw = CaselessKeyword('wait').setResultsName('wait')
    click_kw = CaselessKeyword('click').setResultsName('click')
    dblclick_kw = CaselessKeyword('doubleclick').setResultsName('doubleclick')
    rclick_kw = CaselessKeyword('rightclick').setResultsName('rightclick')
    mouse_kw = CaselessKeyword('mouse').setResultsName('mouse')
    scroll_kw = CaselessKeyword('scroll').setResultsName('scroll')
    drag_kw = CaselessKeyword('drag').setResultsName('drag')
    press_kw = CaselessKeyword('press').setResultsName('press')
    hold_kw = CaselessKeyword('hold').setResultsName('hold')
    release_kw = CaselessKeyword('release').setResultsName('release')
    type_kw = CaselessKeyword('type').setResultsName('type')
    back_kw = CaselessKeyword('back').setResultsName('back')
    forward_kw = CaselessKeyword('forward').setResultsName('forward')
    refresh_kw = CaselessKeyword('refresh').setResultsName('refresh')
    accept_kw = Group(CaselessKeyword('accept')).setResultsName('accept')
    dismiss_kw = Group(CaselessKeyword('dismiss')).setResultsName('dismiss')
    input_kw = CaselessKeyword('input').setResultsName('input')
    auth_kw = CaselessKeyword('authenticate').setResultsName('authenticate')
    assert_kw = CaselessKeyword('assert').setResultsName('assert')

    alert_kw = CaselessKeyword('alert').setResultsName('alert')

    present_kw = CaselessKeyword('present').setResultsName('present')
    absent_kw = CaselessKeyword('absent').setResultsName('absent')
    visible_kw = CaselessKeyword('visible').setResultsName('visible')
    invisible_kw = CaselessKeyword('invisible').setResultsName('invisible')

    screen_size = CaselessKeyword('size').setResultsName('size')
    screen_size_expr = screen_size + pos_coords
    screen_expr = Group(screen_kw + screen_size_expr)

    goto_expr = Group(goto_kw + qstring)

    clear_cache = CaselessKeyword('cache').setResultsName('cache')
    clear_storage = CaselessKeyword('storage').setResultsName('storage')
    clear_cookies = CaselessKeyword('cookies').setResultsName('cookies')
    clear_expr = Group(clear_kw + (
        clear_cache | clear_storage | clear_cookies
    ))

    wait_until = CaselessKeyword('until').setResultsName('until')
    wait_max = CaselessKeyword('max').setResultsName('max')
    wait_for = CaselessKeyword('for').setResultsName('for')
    wait_until_expr = (
    ...
    drag_to = CaselessKeyword('to').setResultsName('to')
    drag_expr = Group(
    ...
    assert_content = CaselessKeyword('content').setResultsName('content')
    assert_in = CaselessKeyword('in').setResultsName('in')
    ...
    assert_source = CaselessKeyword('source').setResultsName('source')
    assert_source_present_expr = (
        assert_source +
        regex +
        (present_kw | absent_kw)
    )
    assert_element = CaselessKeyword('element').setResultsName('element')
    assert_element_visible = CaselessKeyword('visible').setResultsName('visible')
    assert_element_hidden = CaselessKeyword('hidden').setResultsName('hidden')
